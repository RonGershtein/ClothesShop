...
public class ClientConsole {
    ...
    // ------------------------------------------------------------------------
    // doListCustomers(): requests all customers and prints a table.
    ...
    // ------------------------------------------------------------------------
    // displaySaleSummary(): prints a compact summary for a sale.
    // Shows customer type and base/discount/final totals.
    // ------------------------------------------------------------------------
    ...
    // ------------------------------------------------------------------------
    // chatChatLoop(): live chat loop after pairing.
    ...
    // ------------------------------------------------------------------------
    // doList(): requests and prints inventory for a branch.
    ...
    // ------------------------------------------------------------------------
    // doSellCart(): builds a cart and sends SELL_MULTI with all items.
    ...
    // ------------------------------------------------------------------------
    // doBuy(): orders quantity into branch stock for a specific SKU.
    ...
    // ------------------------------------------------------------------------
    // prettyEmployeeRole(): converts a role code to a human-friendly label.
    // Defaults to "Employee" if null or unknown.
    // ------------------------------------------------------------------------
