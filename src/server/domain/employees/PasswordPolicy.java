...
public class PasswordPolicy {
    ...
    public static synchronized boolean validate(String password) {
        if (password == null || password.length() < minimumLength) return false;
        ...
        if (requireLetter && !hasLetter) return false;
        return true;
    }
